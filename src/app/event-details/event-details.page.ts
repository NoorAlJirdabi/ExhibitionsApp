...
export class EventDetailsPage implements OnInit {
       ...
       gestureName: 'drag',
         onStart: ev =>{
          console.log("start now");
             ...
             onMove: ev => {
              rect.nativeElement.style.transform = 'translate(${ev.deltaX}px, ${ev.deltaY}px)';
 ...
 ngAfterViewInit(): void { 
  ...
  constructor(public auth:Auth, public Fb:FBserviceService, public activatedRoute:ActivatedRoute, 
              ...
              public alertCtrl: AlertController, public dragulaService: DragulaService, 
              public toastController:ToastController, public gestureCtrl: GestureController) { 
